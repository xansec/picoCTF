...
from config import (ADMIN_PASSWORD, ADMIN_USERNAME,
                    ...
                    FEEDBACK_ENDPOINT, GAME_PAGE_URL, GROUP_LIMIT,
                    GROUPS_ENDPOINT, JOIN_GROUP_ENDPOINT, JOIN_TEAM_ENDPOINT,
                    LOGIN_ENDPOINT, LOGOUT_ENDPOINT, MAX_TEAM_SIZE,
                    NEWS_PAGE_URL, PROBLEMS_ENDPOINT, PROBLEMS_PAGE_URL,
                    PROFILE_PAGE_URL, REGISTRATION_ENDPOINT,
                    REGISTRATION_STATS_ENDPOINT, SCOREBOARD_PAGE_URL,
                    SCOREBOARDS_ENDPOINT, SETTINGS_ENDPOINT, SHELL_PAGE_URL,
                    SHELL_SERVERS_ENDPOINT, STATUS_ENDPOINT,
                    SUBMISSIONS_ENDPOINT, TEAM_ENDPOINT, TEAM_SCORE_ENDPOINT,
                    TEAM_SCORE_PROGRESSION_ENDPOINT,
                    USER_DELETE_ACCOUNT_ENDPOINT, USER_ENDPOINT,
                    USER_EXPORT_ENDPOINT, USER_PASSWORD_CHANGE_ENDPOINT,
                    get_db)
from demographics_generators import (get_affiliation, get_country_code,
                                     get_demographics, get_email,
                                     get_group_name, get_password,
                                     get_team_name, get_user_type,
                                     get_username)
